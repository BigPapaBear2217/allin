...
local function giveReward2(context, data, skipfinal)
	...
	elseif context == "pelt" then
		animal = Config.Animals2[data.model]
		if animal then
			found = true
			money = animal.money or 0
			gold = animal.gold or 0
...
RegisterServerEvent("vorp_hunting:giveReward2")
AddEventHandler("vorp_hunting:giveReward2", giveReward2)
