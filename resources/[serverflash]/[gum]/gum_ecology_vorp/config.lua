...
--[[ ["crp_sugarcane_ac_sim"] =  {
    ...
    ["COMPOSITE_LOOTABLE_PARASOL_MUSHROOM_DEF"] =  {
        ...
        randomized = false,--If you enable Randomized you get 1 from list
        items = {
            {"Parasol_Mushroom", 1, "Parasol Mushroom"},
        },
        animDict = "",
        animPart = "",
        animDur = 0
    ...
    ["COMPOSITE_LOOTABLE_HUMMINGBIRD_SAGE_DEF"] =  {
        ...
        randomized = false,--If you enable Randomized you get 1 from list
        items = {
            {"Hummingbird_Sage", 1, "Hummingbird Sage"},
        },
        animDict = "",
        animPart = "",
        animDur = 0
    ...
    ["COMPOSITE_LOOTABLE_EVERGREEN_HUCKLEBERRY_DEF"] =  {
        ...
        randomized = false,--If you enable Randomized you get 1 from list
        items = {
            {"Evergreen_Huckleberry", 1, "Evergreen huckleberry"},
        },
        animDict = "",
        animPart = "",
        animDur = 0
...
Config.Animals = {
    [GetHashKey("a_c_alligator_01")] =   {
        randomized = false,
        items = {
            {"grosgibier", 2, "Viande Gros gros gibier"},
            {"g_piece_de_cuir", 2, "Grande peau"},
        }
    },    
    ...
    [GetHashKey("a_c_bear_01")] =   {
        randomized = false,
        items = {
            {"grosgibier", 3, "Viande gros gibier"},
    ...
    [GetHashKey("a_c_cardinal_01")] =   {
        randomized = false,
        items = {
            {"gibierplume", 1, "Viande de gibier a plume"},
            {"Feather", 3, "Plume"},
        }
    },    
    ...
    [GetHashKey("a_c_cougar_01")] =   {
        randomized = false,
        items = {
            {"grosgibier", 2, "Viande gros gibier"},
            {"g_piece_de_cuir", 3, "Grande peau"},
        }
    },    
    ...
    [GetHashKey("a_c_moose_01")] =   {
        randomized = false,
        items = {
            {"filandreuse", 3, "Viande filandreuse"},
            {"piece_de_cuir", 3, "Petite peau"},
        }
    },    
