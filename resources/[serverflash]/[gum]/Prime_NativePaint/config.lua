...
Config.Job = { 'Native', 'Native_2' }				-- If you use the Joblock, you set here your Job.

Config.ItemName_1 = ""								-- Set here the Itemname wich you added in your Database (VORP or GUM) or in your Inventory Config. (RedEM)
Config.ItemName_2 = ""								-- Set here the Itemname wich you added in your Database (VORP or GUM) or in your Inventory Config. (RedEM)
Config.ItemName_3 = ""								-- Set here the Itemname wich you added in your Database (VORP or GUM) or in your Inventory Config. (RedEM)	
Config.ItemName_4 = ""								-- Set here the Itemname wich you added in your Database (VORP or GUM) or in your Inventory Config. (RedEM)			
Config.ItemName_5 = ""								-- Set here the Itemname wich you added in your Database (VORP or GUM) or in your Inventory Config. (RedEM)

Config.RemoveAfterUse = false						-- Set to true if you want remove the Item after using.
