        ...
        if (ind == text){
            ...
            if (showdate == 1){
                $('#list2').append(
                    ...
                    "<li><h3'>Time:</h3>&nbsp<h3'>"+tab.time+"</h3></li>",
                    "<li><h3'>Sender Address:</h3>&nbsp<h3'>"+tab.sender+"</h3></li>",
                    "<li><h3'>Letter:</h3>&nbsp<h3'>"+tab.msgs+"</h3></li>",
                ); 
            } else if  (showdate == 0) {
                $('#list2').append(
                    "<li><h3'>Time:</h3>&nbsp<h3'>"+tab.time+"</h3></li>",
...
function loadnewmsgs() { 
    ...
    if (createbutton) {
        $('#list3').append(
            `<button id="newmail"  onclick='viewmsg(${msg})' type="button">You Have ${buttoninfo} New Letters</button>`
        );
...
$(document).ready(function(){
    ...
    window.addEventListener('message', function(event){
        ...
        if (data.action == "show") {
            ...
            $('#landingtitle').html('')
            $('#landingtitle').append(
                `<h3 id = "landingtitle">Mail Address:${mailingadress}</h3> `
            );
