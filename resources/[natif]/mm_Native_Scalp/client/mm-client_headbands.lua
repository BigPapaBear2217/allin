...
-- Testing purposes
if Config.UseScalpCommand then

    RegisterCommand("Scalp", function(source, args)    

        if args ~= nil and args[1] ~= nil then
            AttachHeadbandTypeOnPlayerPed("Scalp" .. tostring(args[1]))
        end
    end)
...
RegisterCommand("DScalp", function(source, args)    
    if args ~= nil then   
        DHeadband()
    end
end)
