...
-- Testing purposes
if Config.UseHeadbandCommand then

    RegisterCommand("Headband", function(source, args)    

        if args ~= nil and args[1] ~= nil then
            AttachHeadbandTypeOnPlayerPed("Headband" .. tostring(args[1]))
        end
    end)
...
RegisterCommand("DHeadband", function(source, args)    
    if args ~= nil then   
        DHeadband()
    end
end)
