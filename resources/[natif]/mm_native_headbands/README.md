...
(ADDING ITEMS)
add the sql file to your db , ensure , restarts your server 


(Commands)
simply use the command /Headband with  corresponding number 
eg /Headband1 /Headband2 to spawn native headbands
use /Dheadband to despawn , this can be turned off in the config
 
#### INSTALATION
* add `ensure mm_native_headbands1` to your file called `resources.cfg`.  
