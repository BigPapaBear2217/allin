...
-- Testing purposes
if Config.UsewandererCommand then

    RegisterCommand("wanderer", function(source, args)    

        if args ~= nil and args[1] ~= nil then
            AttachHeadbandTypeOnPlayerPed("wanderer" .. tostring(args[1]))
        end
    end)
...
RegisterCommand("Dwanderer", function(source, args)    
    if args ~= nil then   
        DHeadband()
    end
end)
