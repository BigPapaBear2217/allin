...
local function addBlipForCoords(blipname, bliphash, coords1, coords2)
    local blip1 = Citizen.InvokeNative(0x554D9D53F696D002, 1664425300, coords1[1], coords1[2], coords1[3])
    ...
    Citizen.InvokeNative(0x9CB1A1623062F402, blip2, blipname)
end

local blipName = "Foins"
local blipHash = 692310
local blipCoords1 = {1409.56, 304.50, 87.60}
local blipCoords2 = {1393.76, 288.33, 87.60}

addBlipForCoords(blipName, blipHash, blipCoords1, blipCoords2)
