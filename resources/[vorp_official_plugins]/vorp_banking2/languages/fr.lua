Languages["fr"] = {
    openmenu = "Menu",
    bank = "Entreprise de stockage",
    welcome = "Bienvenue à chez Mister High je stock et conserves vos objets et nourriture",
    cashbalance = "Argent: $",
    goldbalance = "Or: ",
    ...
    success = "Vous avez mis à niveau votre coffre-fort en payant $ ",
