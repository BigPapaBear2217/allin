...
Config.banks = {
 ...
 --[[  
    Valentine = {
        name = "Valentine Bank",
        x = 2670.99, y = -1250.53, z = 52.73,
        city = "Valentine",
        blipsprite = -2128054417,
        blipAllowed = true,
        NpcAllowed = true,
        NpcModel = "S_M_M_BankClerk_01",
        Nx = 2670.99, Ny = -1250.53, Nz = 52.73, Nh = 190.64, --npc positions
   ...
   Blackwater = {
    ...
    Rhodes = {
	    ...
	    Annesburg = {
        name = "Banque d'Annesburg ",
        x = 2935.29, y = 1286.36, z = 44.7,
        city = "Annesburg",
        blipsprite = -2128054417,
        blipAllowed = true,
        NpcAllowed = true,
        NpcModel = "S_M_M_BankClerk_01",
        Nx = 2935.29, Ny = 1286.36, Nz = 44.7, Nh = 150.08, --npc positions
        StoreHoursAllowed = false,
        StoreOpen = 7, -- am
        StoreClose = 21, -- pm
        distOpen = 1.5,
		...
		Guarma = {
        name = "Banque de Guarma",
        x = 1330.82, y = -6940.58, z = 59.24,
        city = "Guarma",
        blipsprite = -2128054417,
        blipAllowed = true,
        NpcAllowed = true,
