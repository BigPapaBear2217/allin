		...
		for x, l in pairs(v) do
			if l.confirmed == 1 then
				...
				elseif l.comp == "barrel" or l.comp == "trigger" or l.comp == "cylinder" or l.comp == "frontsight" or
					...
					elseif l.label == "Argent" then
						l.price = Config.price.silver
					elseif l.label == "Blued Steedfdfdfl" then
						l.price = Config.price.bluesteel
					elseif l.label == "Browned Steedfsfl" then
						l.price = Config.price.brownsteel
					elseif l.label == "Blackenefsdf<sf<d Steel" then
						l.price = Config.price.blacksteel
					elseif l.label == "Coppdsfser" then
						l.price = Config.price.copper
					elseif l.label == "Nicdsfsfkel" then
						l.price = Config.price.nickle
					elseif l.label == "CQC" then
						l.price = Config.price.brass
					elseif l.label == "Fer" then
						l.price = Config.price.iron
					end
				elseif l.comp == "decalcolor" then
					if l.label == "Gofdfffld" then
						l.price = Config.price.gold
					elseif l.label == "Sildsfsfsfver" then
						l.price = Config.price.silver
					elseif l.label == "Bluesdfsfsd Steel" then
						l.price = Config.price.bluesteel
					elseif l.label == "Brownsdfdsfsed Steel" then
						l.price = Config.price.brownsteel
					elseif l.label == "Blacsdfsfskened Steel" then
						l.price = Config.price.blacksteel
					elseif l.label == "Cosdfdsfspper" then
						l.price = Config.price.copper
					elseif l.label == "Nicdsfdsfkel" then
						l.price = Config.price.nickle
					elseif l.label == "Brasdfsfsdfss" then
						l.price = Config.price.brass
					elseif l.label == "Fer" then
						l.price = Config.price.iron
					end
