...
Config = {
    ...
    job ={ "weapon_j", "rguns", "g_weapons","lakota"},
    jobrankcustomization = 1,
    jobrankcrafting = 1,
    craftingcost =  false,
    ...
    customizationanimation = "WORLD_HUMAN_WRITE_NOTEBOOK", -- animations for customizations
        ...
        customizationLocations = {
            ...
            Lakota = {    
                Pos = {x=2481.61, y=1779.37, z=86.41}, -- location weapon customization station
                Pos2 = {x=2481.77, y=1778.79, z=87.24}, -- location spawned weapon 3d model
            },
        },
        ...
        craftinglocation = { 
            ...
            Valentine = {	   
                Pos = {x=1359.35595703125, y=-6948.6708984375, z=61.82014846801758}, -- location weapon crafting station
            },
        },
