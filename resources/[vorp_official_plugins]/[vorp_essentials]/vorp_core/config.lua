...
Lang = "Francais" -- choose here your language , check translation folder to see if its available in your language
...
Config = {
    ...
    HealthOnResurrection     = 50,                                  -- Player's health when resurrected (MAX = 500)
